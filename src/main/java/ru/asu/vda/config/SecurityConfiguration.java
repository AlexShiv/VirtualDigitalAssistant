...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.GET,"/api/faculties/{id}").permitAll()
            .antMatchers(HttpMethod.POST,"/api/forms").permitAll()
            .antMatchers(HttpMethod.GET,"/api/teachers").permitAll()
            .antMatchers(HttpMethod.GET,"/api/teachers/{id}").permitAll()
            .antMatchers(HttpMethod.GET,"/api/stat/answers").permitAll()
