...
import ru.asu.vda.config.audit.AuditEventConverter;
import ru.asu.vda.domain.PersistentAuditEvent;
...
import static ru.asu.vda.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
